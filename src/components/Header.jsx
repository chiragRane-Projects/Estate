    ...
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage: "url('/header_img.png')"}} id='Header'>
        ...
        className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
            ...
            <div className='space-x-6 mt-16'>
                <a href="#Projects" className='border border-white px-8 py-3 rounded hover:bg-blue-500 transition-colors duration-300'>Projects</a>
                <a href="#Contact" className='bg-cyan-500 px-8 py-3 rounded hover:bg-cyan-600 transition-colors duration-300'>Contact Us</a>
            </div>
        </motion.div>
    </div>
  )
