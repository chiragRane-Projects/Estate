        ...
        <motion.div
            ...
            <div className='flex justify-end items-center mb-8'>
                <button onClick={prevProject} className='p-3 bg-gray-200 rounded mr-2'>
                    <img src={assets.left_arrow} alt="Previous" className='p-3 bg-gray-200 rounded mr-2' aria-label='Previous Projects' />
                </button>
                <button onClick={nextProject} className='p-3 bg-gray-200 rounded mr-2'>
                    <img src={assets.right_arrow} alt="Next Projects" className='p-3 bg-gray-200 rounded mr-2' aria-label='Next Projects' />
                </button>
            </div>
