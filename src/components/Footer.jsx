    ...
    <footer className="bg-gray-900 text-white py-10 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between text-center md:text-left">
        ...
        <div className="flex gap-6 text-2xl">
          <a href="https://www.instagram.com/chiragrane04/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors duration-300">
            <FaInstagram />
          </a>
          ...
          <a href="https://github.com/chiragRane-Projects/Estate" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors duration-300">
            <FaGithub />
          </a>
        </div>
      </div>
